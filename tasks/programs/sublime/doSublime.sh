...
cp templates/michondr.sublime-keymap ~/.config/sublime-text-3/Packages/User/Default.sublime-keymap
cp templates/preferences.sublime-settings ~/.config/sublime-text-3/Packages/User/Preferences.sublime-settings
cp templates/close_without_saving.py ~/.config/sublime-text-3/Packages/User/close_without_saving.py

# auto install packages (those are specified in package_control and will be downloaded on first opening of sublime)
cp templates/package-control.sublime-settings ~/.config/sublime-text-3/Packages/User/Package\ Control.sublime-settings
