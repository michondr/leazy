#!/usr/bin/env bash
sudo apt --assume-yes install vim git htop chromium-browser curl python-pip python-pytest pipenv ansible exfat-fuse exfat-utils xclip flameshot awscli nginx
