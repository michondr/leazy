#!/usr/bin/env bash
sudo apt --assume-yes install vim git htop chromium-browser default-jdk default-jre curl python-pip ansible exfat-fuse exfat-utils xclip flameshot awscli
